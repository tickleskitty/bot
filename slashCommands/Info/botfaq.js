...
module.exports = {
    ...
    run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
      ...
      let UnifyHostMembers = await UnifyHostServer.members.fetch();
      let partnercount = "0"
      ...
      .setColor(es.color)
      .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/2YwAhGCgnx")
      ...
      function menuselection(interaction) {
        ...
        .setColor(es.color)
        .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/2YwAhGCgnxgnx")
