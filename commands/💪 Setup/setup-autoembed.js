    ...
    try {
      ...
      async function first_layer(){
        let menuoptions = [{
          ...
          {
            value: "Cancel",
            description: `Cancel and stop the Auto-Embed-Setup!`,
        ...
        .setColor(es.color)
        .setAuthor('Auto Embed Setup', 'https://cdn.discordapp.com/emojis/850829013438300221.png?size=96', 'https://discord.gg/2YwAhGCgnx')
