    ...
    if (message.author.id != "725691879479312405")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only Logan is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://discord.gg/2YwAhGCgnx), open a Ticket and ask for it!`)
        ]
      });
    try {
